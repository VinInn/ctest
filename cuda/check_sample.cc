...
TYPE extra[SIZE_EXTRA] = {
  ...
  TYPE worst[SIZE] = {
   ...
   /* cbrt */
    ...
    -0x1.ff3e9d3ecc941p+9,  /* CUDA 11.2 */
    /* expm1 */
    ...
    0x1.8908bc4077d04p+421,  /* CUDA 11.2 */
    /* log1p */
    ...
    -0x1.fffed917b9531p-2,  /* CUDA 11.2 */
    /* log2 */
    ...
    0x1.002fe48931681p+12,  /* CUDA 11.2 */
    /* tanh */
    ...
    0x1.30c217b4a2239p+25,  /* CUDA 11.2 */
    /* y1 */
