...
template<> constexpr float approx_atan2f_P< 9 >(float x){
  auto z = x*x;
...
template<> constexpr float approx_atan2f_P< 11 >(float x){
  auto z = x*x;
...
template<> constexpr float approx_atan2f_P< 13 >(float x){
  auto z = x*x;
...
template<> constexpr float approx_atan2f_P< 15 >(float x){
  auto z = x*x;
